...
public class ComponentTimerRelay extends Component {
    ...
    public ComponentTimerRelay(Context context,AttributeSet attrs) {
        super(context, attrs);
    }

    public ComponentTimerRelay(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ComponentTimerRelay(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
