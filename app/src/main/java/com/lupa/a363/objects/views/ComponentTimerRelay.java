...
public class ComponentTimerRelay extends Component {
    public ComponentTimerRelay(Context context) {
        super(context);
    }

    public ComponentTimerRelay(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ComponentTimerRelay(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public ComponentTimerRelay(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
